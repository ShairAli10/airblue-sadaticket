...
<div class="offcanvas-body">
    ...
    <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
        ...
        <li class="nav-item active">
            <a class="nav-link active" data-bs-toggle="tab" href="#itineraries" role="tab" aria-selected="false">
                Flight Itineraries
            </a>
        </li>
    ...
    <div class="tab-content text-muted">
        ...
        <!-- End Fare Option -->
        <!----------------------------------------- Itineraries --------------------------------------------->
        <div class="tab-pane active" id="itineraries" role="tabpanel">
    ...
    $(document).ready(function() {
        $('input[type="radio"][name^="brand_ref_key"]').change(function() {
            ...
            $.each(passengerFares, function(index, fare) {
                ...
                passBreak[index]['BasePrice'] += parseInt(fare['BasePrice']);
                passBreak[index]['TaxPrice'] += parseInt(fare['Taxes']);
                passBreak[index]['TotalPaxPrice'] += parseInt(fare['TotalPrice']);
