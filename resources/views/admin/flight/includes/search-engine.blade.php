        ...
        <div class="row">
            ...
            <div class="col-12 mt-3">
                <div class="row g-2 gy-3">
                    ...
                    <div class="col-lg-2 col-md-6 col-6 order-lg-1">
                        <label for="from"
                    ...
                    <div class="col-lg-2 col-md-6 col-6 order-lg-2">
                        <label for="to"
                            class="input-label ms-3 bg-transparent border-0 position-absolute top-0 translate-middle-y">
                    ...
                    <div class="col-lg col-md-8 order-lg-3">
                        <div class="row g-2 gy-3">
                            <div class="col">
                                <label for="departure"
                                    class="input-label ms-3 bg-transparent border-0 position-absolute top-0 translate-middle-y">
                    ...
                    <div class="col-lg-3 col-md-4 order-lg-4">
