                                    ...
                                    <div class="float-end font-size-15" style="padding-right: 50px;">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end" style="">
                                                <a class="dropdown-item" href="{{ route('admin.create.booking', ['booking_ref' => encrypt($item->id)]) }}">View Booking</a>
                            ...
                            <div class="card-body">
                                <div class="invoice-title d-flex justify-content-between">
                                    <div class="text-muted">
                                        ...
                                        <p><i class="mdi mdi-phone-outline me-1"></i> Phone: {{ $customer['phone'] }}</p>
                                    </div>
