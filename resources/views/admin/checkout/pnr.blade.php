                    ...
                    <div class="d-flex justify-content-between mb-2">
                        <div>
                            {{-- @if ($order->admin->type == 'Admin User') --}}
                                <img src="{{ asset('assets/images/'.config('constants.sadaticket-webp')) }}" height="80px" alt="Indus">
                            {{-- @else
                    ...
                    <div class="col-12">
                        <div class="card bg-primary bg-gradient text-white p-3 rounded-1">
                            <div class="d-block d-lg-flex justify-content-between">
                                <span>
                                    <h5 class="text-white fw-bold mb-0">GDS PNR: {{ @$order->pnrCode}}</h5>
                                    {{-- <p class="mb-0" style="font-size: 12px;">Booking Ref ID:</p> --}}
                                ...
                                <div class="col-md-12 rounded-1">
                                    ...
                                    <div class="d-flex justify-content-between text-dark border-bottom border-2 p-3 m-0 pb-3">
                                        ...
                                        <span class=" text-end fw-bold">
                                            ...
                                            <span>{{ (@$RuleType == 'Mark Up') ? '+' : '-' }} {{ $CurrencyCode }} @if(@$RuleType == 'Mark Up'){{ number_format($Markup) }} @else {{ number_format($Discount) }} @endif</span><br>
                                            <span>0</span><br>
                                        </span>
                                    </div>
