                                    ...
                                    <div class="card-body">
                                        ...
                                        @if(@$query['adults'] > 0)
                                            @for ($adt = 1; $adt <= $query['adults']; $adt++)
                                                <div class="passenger_adults rounded p-4 border mb-3">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            @for ($cnn = 1; $cnn <= $query['children']; $cnn++)
                                                <div class="passenger_childs rounded p-4 border mb-3">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            @for ($inf = 1; $inf <= $query['infants']; $inf++)
                                                <div class="passenger_infants rounded p-4 border mb-3">
                                                    <div class="row">
                                                        <div class="col-md-6">
