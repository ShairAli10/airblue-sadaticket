                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            @if(auth('admin')->user()->can('Create-Agent-Pricing'))
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul class="list-inline mb-0">
                                                        @if(auth('admin')->user()->can('Edit-Agent-Pricing'))
                                                        ...
                                                        @endif
                                                        @if(auth('admin')->user()->can('Delete-Agent-Pricing'))
                                                            <li class="list-inline-item">
...
@if(Auth::guard('admin')->user()->type == 'admin')
    ...
    @include('admin.pricing-engine-agent.create-rule-modal')
@endif
@endsection
...
<script>
    function editRule(id){
        ...
        $.ajax({
            url: "{{ url('admin/pricing-engine/edit') }}/" + id,
            method: 'GET',
