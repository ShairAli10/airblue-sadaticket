                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h4 class="text-muted">Rule List</h4>
                            <a href="{{ route('admin.pricingEngine.create',[$admin_user->id]) }}" class="btn btn-primary">Create New</a>
                        </div>
                        <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul class="list-inline mb-0">
                                                        ...
                                                        <li class="list-inline-item">
                                                            <a href="{{ route('admin.pricingEngine.delete',[$admin_user->id,$item->id])}}" onclick="return  confirm('Are you sure yout want to delete this Rule')" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" class="px-2 text-danger">
