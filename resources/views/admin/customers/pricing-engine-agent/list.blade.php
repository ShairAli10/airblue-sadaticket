                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h4 class="text-muted">Customer Rule List</h4>
                            @if(auth('admin')->user()->can('Create-Customer-Pricing'))
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul class="list-inline mb-0">
                                                        @if(auth('admin')->user()->can('Edit-Customer-Pricing'))
                                                        ...
                                                        @endif
                                                        @if(auth('admin')->user()->can('Delete-Customer-Pricing'))
                                                            <li class="list-inline-item">
                                                                <a href="{{ route('admin.customer.pricingEngine.delete',[$item->id])}}" onclick="return  confirm('Are you sure yout want to delete this Rule')" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" class="px-2 text-danger">
...
@include('admin.customers.pricing-engine-agent.create-rule-modal')
@endif
@endsection
...
<script>
    function editRule(id){
        ...
        $.ajax({
            url: "{{ url('admin/customer/pricing-engine/edit') }}/" + id,
            method: 'GET',
