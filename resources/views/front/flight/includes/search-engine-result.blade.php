<div class="container-fluid search-result-header">
    <div class="container">
        <div class="row search-details-row search-details-row-desktop">
        <i class="fa fa-close widget-close"></i>	
            ...
            <div class="col-12 search-row-wrapper">
                <div class="check-box-row p-0 pt-2">
                    <div class="form-check d-flex flex-wrap align-items-center">
                        ...
                        <input type="radio" value="oneway" name="trip_type_chk" id="oneway-trip" {{ ($_GET['tripType'] == 'oneway') ? 'checked' : ''}}> <span>One Way</span></label>
                    </div>
                    <div class="form-check d-flex flex-wrap align-items-center">
                        <label class="form-check-label btn-round-trip" for="round-trip">
                        <input type="radio" value="return" name="trip_type_chk" id="round-trip" {{ ($_GET['tripType'] == 'return') ? 'checked' : ''}}> <span>Round-Trip</span></label>
                    </div>
                    <div class="form-check d-flex flex-wrap align-items-center">
                    ...
                    <div class="search-result-row-select-wrap pe-4">
                        <div class="select-wrap">
                            <a href="#" class="passenger-change ">
                                ...
                                </svg>&nbsp;<span class="passenger-count">{{ $_GET['adults'] + $_GET['children'] + $_GET['infants'] }}</span> Passenger(s)</p>  
                            </a>
                                ...
                                <div class="row no-gutter">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="input-group input-group-sm pull-right">
                                            ...
                                            <input type="text" class="form-control text-center spinner-value-flight" name="adult_count" id="adult_count" value="{{ $_GET['adults']}}" max="9" min="1" readonly="readonly">
                                            <span class="input-group-btn">
                                ...
                                <div class="row no-gutter">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="input-group input-group-sm pull-right">
                                            ...
                                            <input type="text" class="form-control text-center spinner-value-flight" name="child_count" id="child_count" value="{{ $_GET['children']}}" max="8" min="0" readonly="readonly">
                                            <span class="input-group-btn">
                                ...
                                <div class="row no-gutter">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="input-group input-group-sm pull-right">
                                            ...
                                            <input type="text" class="form-control text-center spinner-value-flight" name="infant_count" id="infant_count" value="{{ $_GET['infants']}}" max="4" min="0" readonly="readonly">
                                            <span class="input-group-btn">
                    ...
                    <form autocomplete="off" name="flight" id="flight" action="" class="row flight-search-form" novalidate="true">
                        <div class="form-row">
                            <div class="row no-gutter search-inputs-row">
                                <div class="flight-from col-6 col-sm-6 col-md-4 col-lg-{{ ($_GET['tripType'] == 'return') ? '3' : '4'}} pe-0">
                                    <div class="search-input mb-0 form-group">
                                        ...
                                        <input class="form-control autocomplete-airports typeahead typeahead_origion" name="origin" value="{{ $_GET['origin']}}" id="typeahead_origion_desc" placeholder="Flying from" tabindex="1" required="">
                                ...
                                <div class="flight-to col-6 col-sm-6 col-md-4 col-lg-{{ ($_GET['tripType'] == 'return') ? '3' : '4'}} pe-0">
                                    <div class="search-input mb-0 form-group">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="17" viewBox="0 0 15 17" fill="none">
                                            <path d="M7.5 9.20898C8.6736 9.20898 9.625 8.25759 9.625 7.08398C9.625 5.91038 8.6736 4.95898 7.5 4.95898C6.32639 4.95898 5.375 5.91038 5.375 7.08398C5.375 8.25759 6.32639 9.20898 7.5 9.20898Z" stroke="#333333" stroke-width="2.33333" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M7.49967 1.41699C5.99678 1.41699 4.55544 2.01401 3.49274 3.07672C2.43003 4.13943 1.83301 5.58077 1.83301 7.08366C1.83301 8.42383 2.11776 9.30074 2.89551 10.2712L7.49967 15.5837L12.1038 10.2712C12.8816 9.30074 13.1663 8.42383 13.1663 7.08366C13.1663 5.58077 12.5693 4.13943 11.5066 3.07672C10.4439 2.01401 9.00257 1.41699 7.49967 1.41699V1.41699Z" stroke="#333333" stroke-width="2.33333" stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg>
                                        <input class="autocomplete-airports form-control typeahead typeahead_distination" type="text" name="destination" value="{{ $_GET['destination']}}" id="typeahead_distination_desc" tabindex="2" placeholder="Flying to" required="">
                                    </div>
                                </div>

                                <div class="col-12 d-flex align-items-end col-md-4 col-lg-{{ ($_GET['tripType'] == 'return') ? '6' : '4'}} mt-sm-3 pe-sm-3 pe-xs-3" id="depart_div">
                                    <div class="date-input date-from mb-0">
                                        ...
                                        <input type="date" class="form-control from-date pl-5" name="depature" value="{{ $_GET['depature']}}" readonly="true" autocomplete="off" required="" tabindex="3" id="dapart_date">
                                    </div>
                                    <div class="date-input date-from mb-0 date-return-active" style="display:{{ ($_GET['tripType'] == 'return') ? 'block' : 'none'}};">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                            <path d="M3.9375 0C4.08668 0 4.22976 0.0592632 4.33525 0.164752C4.44074 0.270242 4.5 0.413316 4.5 0.5625V1.125H13.5V0.5625C13.5 0.413316 13.5593 0.270242 13.6648 0.164752C13.7702 0.0592632 13.9133 0 14.0625 0C14.2117 0 14.3548 0.0592632 14.4602 0.164752C14.5657 0.270242 14.625 0.413316 14.625 0.5625V1.125H15.75C16.3467 1.125 16.919 1.36205 17.341 1.78401C17.7629 2.20597 18 2.77826 18 3.375V15.75C18 16.3467 17.7629 16.919 17.341 17.341C16.919 17.7629 16.3467 18 15.75 18H2.25C1.65326 18 1.08097 17.7629 0.65901 17.341C0.237053 16.919 0 16.3467 0 15.75V3.375C0 2.77826 0.237053 2.20597 0.65901 1.78401C1.08097 1.36205 1.65326 1.125 2.25 1.125H3.375V0.5625C3.375 0.413316 3.43426 0.270242 3.53975 0.164752C3.64524 0.0592632 3.78832 0 3.9375 0V0ZM1.125 4.5V15.75C1.125 16.0484 1.24353 16.3345 1.4545 16.5455C1.66548 16.7565 1.95163 16.875 2.25 16.875H15.75C16.0484 16.875 16.3345 16.7565 16.5455 16.5455C16.7565 16.3345 16.875 16.0484 16.875 15.75V4.5H1.125Z" fill="#333333"/>
                                        </svg>
                                        <input type="date" class="form-control to-date pl-5" name="return" value="{{ @$_GET['return']}}" readonly="true" autocomplete="off" required="" tabindex="4" id="return_date">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <input type="hidden" class="trip-type-hidden" name="trip_type" id="tripType" value="{{ @$_GET['tripType']}}">
                    </form>
                </div>
                {{-- ------------------Mobile -------------------- --}}
                <div class="flight-tab-switcher d-none" id="multi-block">
                    <form autocomplete="off" name="flight" id="flight2" action="" class="row flight-search-form" novalidate="true">
                        <div class="form-row">
                            <div class="row no-gutter">
                                <div class="flight-from col-6 col-md-6 col-sm-6 col-lg-4 pe-0">
                                    <div class="search-input mb-0 form-group">
                                        ...
                                        <input class="form-control autocomplete-airports" name="from" value="" id="autocomplete11" placeholder="Flying from" tabindex="1" required="">
                                        <a href="javascript:void(0);" class="btn-way-switch" onclick="changeDepartArrival();">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="flip-ico" width="28" height="28" viewBox="0 0 28 28" fill="none">
                                                <circle cx="14" cy="14" r="14" fill="#C4C4C4"></circle>
                                                <path d="M12 8.99959C11.7348 8.99959 11.4804 9.10495 11.2929 9.29249C11.1054 9.48002 11 9.73438 11 9.99959C11 10.2648 11.1054 10.5192 11.2929 10.7067C11.4804 10.8942 11.7348 10.9996 12 10.9996H17.586L16.293 12.2926C16.1108 12.4812 16.01 12.7338 16.0123 12.996C16.0146 13.2582 16.1198 13.509 16.3052 13.6944C16.4906 13.8798 16.7414 13.985 17.0036 13.9873C17.2658 13.9895 17.5184 13.8888 17.707 13.7066L20.707 10.7066C20.8945 10.5191 20.9998 10.2648 20.9998 9.99959C20.9998 9.73443 20.8945 9.48012 20.707 9.29259L17.707 6.29259C17.6148 6.19708 17.5044 6.1209 17.3824 6.06849C17.2604 6.01608 17.1292 5.9885 16.9964 5.98734C16.8636 5.98619 16.7319 6.01149 16.609 6.06177C16.4861 6.11205 16.3745 6.18631 16.2806 6.2802C16.1867 6.37409 16.1125 6.48574 16.0622 6.60864C16.0119 6.73154 15.9866 6.86321 15.9877 6.99599C15.9889 7.12877 16.0165 7.25999 16.0689 7.382C16.1213 7.504 16.1975 7.61435 16.293 7.70659L17.586 8.99959H12Z" fill="#333333"></path>
                                ...
                                <div class="flight-to col-6 col-sm-6 col-md-6 col-lg-4 pe-sm-0">
                                    <div class="search-input mb-0 form-group">
                                        ...
                                        <input type="text" name="to" value="" id="mbl-autocomplete2" tabindex="2" placeholder="Flying to" class="autocomplete-airports form-control" required="">
                                    </div>
                                </div>

                                <div class="col-12 d-flex align-items-end col-xs-6 col-lg-4" id="depart_div">
                                    <div class="date-input date-from mb-0">
                                        <img src="{{ asset('front-assets/icons/calender.svg')}}" alt="Departure Calendar Icon">
                                        <input type="date" class="form-control from-date pl-5 hasDatepicker" name="depature" value="" readonly="true" autocomplete="off" required="" tabindex="3" id="ddddp1691605320661">
                                    </div>
                                </div>
                            </div>
                            <div class="row no-gutter mb-3">
                                <div class="flight-from col-6 col-sm-6 col-md-6 col-lg-4 pe-0">
                                    <div class="search-input mb-0 form-group">
                                        ...
                                        <input class="form-control autocomplete-airports" name="from" value="" id="autocomplete12" placeholder="Flying from" tabindex="1" required="">
                                ...
                                <div class="col-12 d-flex align-items-end col-xs-6 col-lg-4" id="depart_div">
                                    <div class="date-input date-from mb-0">
                                        <img src="{{ asset('front-assets/icons/calender.svg')}}" alt="Departure Calendar Icon">
                                        <input type="date" class="form-control from-date pl-5 hasDatepicker" name="depature" value="" readonly="true" autocomplete="off" required="" tabindex="3" id="ddp1691605320661">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="search-result-column modify-btn-desktop ms-auto">
                    <button class="green_btn" onclick="submitDesktop()">Modify</button>
                </div>

            </div>
            <div class="modify-btn-mobile p-0 ms-auto">
                <button class="green_btn w-100 widget-close-submit" onclick="submitDesktop()">Submit</button>
            </div>

            <div class="search-result-column d-none">
                <div class="from-to-detail">
                    <div class="result-flight-from">
                        <p class="f-14px">From</p>
                        <h6>{{ $_GET['origin']}}</h6>
                    </div>
                    ...
                    <div class="result-flight-destination">
                        <p class="f-14px">Destination</p>
                        <h6>{{ $_GET['origin']}}</h6>
                    </div>
                </div>
            </div>
            <div class="search-result-column d-none">
                <div class="search-departure-date">
                    <p class="dptr-title m-0">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none"><path d="M3.9375 0C4.08668 0 4.22976 0.0592632 4.33525 0.164752C4.44074 0.270242 4.5 0.413316 4.5 0.5625V1.125H13.5V0.5625C13.5 0.413316 13.5593 0.270242 13.6648 0.164752C13.7702 0.0592632 13.9133 0 14.0625 0C14.2117 0 14.3548 0.0592632 14.4602 0.164752C14.5657 0.270242 14.625 0.413316 14.625 0.5625V1.125H15.75C16.3467 1.125 16.919 1.36205 17.341 1.78401C17.7629 2.20597 18 2.77826 18 3.375V15.75C18 16.3467 17.7629 16.919 17.341 17.341C16.919 17.7629 16.3467 18 15.75 18H2.25C1.65326 18 1.08097 17.7629 0.65901 17.341C0.237053 16.919 0 16.3467 0 15.75V3.375C0 2.77826 0.237053 2.20597 0.65901 1.78401C1.08097 1.36205 1.65326 1.125 2.25 1.125H3.375V0.5625C3.375 0.413316 3.43426 0.270242 3.53975 0.164752C3.64524 0.0592632 3.78832 0 3.9375 0V0ZM1.125 4.5V15.75C1.125 16.0484 1.24353 16.3345 1.4545 16.5455C1.66548 16.7565 1.95163 16.875 2.25 16.875H15.75C16.0484 16.875 16.3345 16.7565 16.5455 16.5455C16.7565 16.3345 16.875 16.0484 16.875 15.75V4.5H1.125Z" fill="#333333"></path></svg>
                        <span class="f-14px">Departure</span>
                    </p>
                    <span class="dptr-date font-500">24<sup>th</sup> Oct 2023</span>
                </div>
            </div>
            <div class="search-result-column d-none">
                <div class="search-return-date">
                    <p class="return-title m-0">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none"><path d="M3.9375 0C4.08668 0 4.22976 0.0592632 4.33525 0.164752C4.44074 0.270242 4.5 0.413316 4.5 0.5625V1.125H13.5V0.5625C13.5 0.413316 13.5593 0.270242 13.6648 0.164752C13.7702 0.0592632 13.9133 0 14.0625 0C14.2117 0 14.3548 0.0592632 14.4602 0.164752C14.5657 0.270242 14.625 0.413316 14.625 0.5625V1.125H15.75C16.3467 1.125 16.919 1.36205 17.341 1.78401C17.7629 2.20597 18 2.77826 18 3.375V15.75C18 16.3467 17.7629 16.919 17.341 17.341C16.919 17.7629 16.3467 18 15.75 18H2.25C1.65326 18 1.08097 17.7629 0.65901 17.341C0.237053 16.919 0 16.3467 0 15.75V3.375C0 2.77826 0.237053 2.20597 0.65901 1.78401C1.08097 1.36205 1.65326 1.125 2.25 1.125H3.375V0.5625C3.375 0.413316 3.43426 0.270242 3.53975 0.164752C3.64524 0.0592632 3.78832 0 3.9375 0V0ZM1.125 4.5V15.75C1.125 16.0484 1.24353 16.3345 1.4545 16.5455C1.66548 16.7565 1.95163 16.875 2.25 16.875H15.75C16.0484 16.875 16.3345 16.7565 16.5455 16.5455C16.7565 16.3345 16.875 16.0484 16.875 15.75V4.5H1.125Z" fill="#333333"></path></svg>
                        <span class="f-14px">Return</span>
                    </p>
                    <span class="return-date font-500">22<sup>th</sup> Nov 2023</span>
                </div>
            </div>
            <div class="search-result-column d-none">
                <div class="search-class-detail">
                    <p class="class-title m-0">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                            <path d="M4.45818 4.69981C3.70818 4.16647 3.52485 3.13314 4.04985 2.37481C4.57485 1.62481 5.61651 1.44147 6.37485 1.96647C7.12485 2.49981 7.30818 3.53314 6.78318 4.29147C6.24985 5.04147 5.21651 5.22481 4.45818 4.69981ZM13.3332 16.6665C13.3332 16.2081 12.9582 15.8331 12.4998 15.8331H7.44151C6.20818 15.8331 5.15818 14.9331 4.97485 13.7165L3.46651 6.48314C3.42878 6.29906 3.32847 6.13372 3.18263 6.01523C3.03679 5.89673 2.85442 5.83239 2.66651 5.83314C2.14985 5.83314 1.76651 6.30814 1.86651 6.81647L3.32485 13.9665C3.47793 14.9506 3.9778 15.8477 4.73424 16.4956C5.49068 17.1435 6.45384 17.4997 7.44985 17.4998H12.4998C12.9582 17.4998 13.3332 17.1248 13.3332 16.6665ZM12.9498 12.4998H9.45818L8.59985 9.08314C9.66651 9.68314 10.7915 10.1498 12.0165 10.1665C12.4998 10.1748 12.8915 9.75814 12.8915 9.27481C12.8915 8.78314 12.4832 8.40814 11.9915 8.39147C10.8998 8.35814 9.79985 7.92481 8.98318 7.28314L7.61651 6.22481C7.42485 6.07481 7.20818 5.97481 6.98318 5.90814C6.71552 5.82918 6.43342 5.81209 6.15818 5.85814H6.14151C5.65079 5.94526 5.21434 6.22269 4.92717 6.63004C4.64 7.03739 4.52535 7.54168 4.60818 8.03314L5.73318 12.9665C5.8431 13.5381 6.14855 14.0537 6.59712 14.4247C7.04568 14.7957 7.60939 14.9991 8.19151 14.9998H13.8998L16.4748 17.0165C16.8248 17.2915 17.3248 17.2581 17.6332 16.9498C18.0082 16.5748 17.9665 15.9665 17.5498 15.6415L13.9748 12.8498C13.6814 12.6228 13.3208 12.4997 12.9498 12.4998Z" fill="#333333"></path>
                    </svg>								
                    <span class="f-14px">Class</span>
                    </p>
                    <span class="class-category font-500">Economy</span>
                </div>
            </div>
            <div class="search-result-column d-none">
                <div class="search-result-passenger-detail">
                    <p class="m-0">
                        <svg xmlns="http://www.w3.org/2000/svg" width="12" height="13" viewBox="0 0 12 13" fill="none"><path d="M11.5292 10.609C11.2282 9.8793 10.7914 9.21645 10.2431 8.65741C9.69641 8.09676 9.04886 7.64976 8.33615 7.34108C8.32977 7.33781 8.32339 7.33618 8.31701 7.33291C9.31115 6.59799 9.95742 5.40088 9.95742 4.05025C9.95742 1.81281 8.18616 0 6 0C3.81384 0 2.04258 1.81281 2.04258 4.05025C2.04258 5.40088 2.68885 6.59799 3.68299 7.33455C3.67661 7.33781 3.67023 7.33945 3.66385 7.34271C2.94896 7.65138 2.30747 8.09397 1.75694 8.65905C1.20914 9.21851 0.772382 9.88126 0.470781 10.6107C0.174489 11.3248 0.0146918 12.0904 3.99029e-05 12.8661C-0.000386007 12.8835 0.00260125 12.9009 0.00882574 12.9171C0.0150502 12.9333 0.024386 12.9481 0.0362829 12.9606C0.0481797 12.9731 0.0623971 12.983 0.0780971 12.9898C0.0937971 12.9965 0.110662 13 0.127699 13H1.08514C1.15535 13 1.2112 12.9428 1.2128 12.8726C1.24471 11.6118 1.73939 10.431 2.61385 9.53606C3.51863 8.61005 4.72022 8.1005 6 8.1005C7.27978 8.1005 8.48137 8.61005 9.38615 9.53606C10.2606 10.431 10.7553 11.6118 10.7872 12.8726C10.7888 12.9445 10.8446 13 10.9149 13H11.8723C11.8893 13 11.9062 12.9965 11.9219 12.9898C11.9376 12.983 11.9518 12.9731 11.9637 12.9606C11.9756 12.9481 11.9849 12.9333 11.9912 12.9171C11.9974 12.9009 12.0004 12.8835 12 12.8661C11.984 12.0854 11.826 11.326 11.5292 10.609V10.609ZM6 6.8593C5.26756 6.8593 4.5782 6.56696 4.05959 6.03618C3.54097 5.5054 3.25534 4.79987 3.25534 4.05025C3.25534 3.30063 3.54097 2.5951 4.05959 2.06432C4.5782 1.53354 5.26756 1.24121 6 1.24121C6.73244 1.24121 7.4218 1.53354 7.94041 2.06432C8.45903 2.5951 8.74466 3.30063 8.74466 4.05025C8.74466 4.79987 8.45903 5.5054 7.94041 6.03618C7.4218 6.56696 6.73244 6.8593 6 6.8593Z" fill="#333333"></path></svg>
                        <span class="f-14px">Passenger(s)</span>
                    </p>
                    <span class="passengers-detail font-500">
                        <span>1 Adult</span>, <span>0 Child</span>, <span>0 Infant</span> 
                    </span>
                </div>
            </div>
        </div>

        <div class="row search-details-row search-details-row-mobile">
            <div class="search-result-column d-flex justify-content-between align-items-center p-0">
                <div class="from-to-detail">
                    <div class="result-flight-from">
                        <p class="d-none">From</p>
                        <p class="f-14px m-0">Dubai</p>
                    </div>
                    <div class="flight-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd"><path d="M20.012 18v2h-20v-2h20zm3.973-13.118c.154 1.349-.884 2.615-1.927 3.491-.877.735-9.051 6.099-9.44 6.307-1.756.936-3.332 1.306-4.646 1.32-1.36.014-2.439-.354-3.144-.872l-4.784-3.977 3.742-2.373 4.203 1.445.984-.578-4.973-3.645 3.678-2.124 7.992 1.545c.744-.445 1.482-.9 2.225-1.348 1.049-.623 2.056-1.055 3.387-1.055 1.321 0 2.552.52 2.703 1.864zm-4.341.512c-.419.192-3.179 1.882-3.615 2.144l-8.01-1.55-.418.241 5.288 3.307-4.683 2.876-4.214-1.448-.69.395c.917.729 1.787 1.522 2.751 2.186 1.472.962 4.344.22 5.685-.663.9-.592 7.551-4.961 8.436-5.582.605-.431 1.797-1.414 1.824-2.152l.001-.004c-.644-.287-1.716-.041-2.355.25z"/></svg>
                    </div>
                    <div class="result-flight-destination">
                        <p class="d-none">Destination</p>
                        <p class="f-14px m-0">Islamabad</p>
                    </div>
                    <span class="f-14px dptr-date font-500">24<sup>th</sup> Oct</span>
                </div>
                <button class="green_btn search-modify-btn">
                    Modify
                </button>
            </div>
            <div class="search-result-column d-none justify-content-between align-items-center p-0">
                <div class="search-departure-date">
                    <p class="dptr-title m-0">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none"><path d="M3.9375 0C4.08668 0 4.22976 0.0592632 4.33525 0.164752C4.44074 0.270242 4.5 0.413316 4.5 0.5625V1.125H13.5V0.5625C13.5 0.413316 13.5593 0.270242 13.6648 0.164752C13.7702 0.0592632 13.9133 0 14.0625 0C14.2117 0 14.3548 0.0592632 14.4602 0.164752C14.5657 0.270242 14.625 0.413316 14.625 0.5625V1.125H15.75C16.3467 1.125 16.919 1.36205 17.341 1.78401C17.7629 2.20597 18 2.77826 18 3.375V15.75C18 16.3467 17.7629 16.919 17.341 17.341C16.919 17.7629 16.3467 18 15.75 18H2.25C1.65326 18 1.08097 17.7629 0.65901 17.341C0.237053 16.919 0 16.3467 0 15.75V3.375C0 2.77826 0.237053 2.20597 0.65901 1.78401C1.08097 1.36205 1.65326 1.125 2.25 1.125H3.375V0.5625C3.375 0.413316 3.43426 0.270242 3.53975 0.164752C3.64524 0.0592632 3.78832 0 3.9375 0V0ZM1.125 4.5V15.75C1.125 16.0484 1.24353 16.3345 1.4545 16.5455C1.66548 16.7565 1.95163 16.875 2.25 16.875H15.75C16.0484 16.875 16.3345 16.7565 16.5455 16.5455C16.7565 16.3345 16.875 16.0484 16.875 15.75V4.5H1.125Z" fill="#333333"></path></svg>
                        <span class="f-12px">Departure</span>
                    </p>
                    <span class="f-14px dptr-date font-500">24<sup>th</sup> Oct 2023</span>
                </div>
                <div class="search-return-date">
                    <p class="return-title m-0">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none"><path d="M3.9375 0C4.08668 0 4.22976 0.0592632 4.33525 0.164752C4.44074 0.270242 4.5 0.413316 4.5 0.5625V1.125H13.5V0.5625C13.5 0.413316 13.5593 0.270242 13.6648 0.164752C13.7702 0.0592632 13.9133 0 14.0625 0C14.2117 0 14.3548 0.0592632 14.4602 0.164752C14.5657 0.270242 14.625 0.413316 14.625 0.5625V1.125H15.75C16.3467 1.125 16.919 1.36205 17.341 1.78401C17.7629 2.20597 18 2.77826 18 3.375V15.75C18 16.3467 17.7629 16.919 17.341 17.341C16.919 17.7629 16.3467 18 15.75 18H2.25C1.65326 18 1.08097 17.7629 0.65901 17.341C0.237053 16.919 0 16.3467 0 15.75V3.375C0 2.77826 0.237053 2.20597 0.65901 1.78401C1.08097 1.36205 1.65326 1.125 2.25 1.125H3.375V0.5625C3.375 0.413316 3.43426 0.270242 3.53975 0.164752C3.64524 0.0592632 3.78832 0 3.9375 0V0ZM1.125 4.5V15.75C1.125 16.0484 1.24353 16.3345 1.4545 16.5455C1.66548 16.7565 1.95163 16.875 2.25 16.875H15.75C16.0484 16.875 16.3345 16.7565 16.5455 16.5455C16.7565 16.3345 16.875 16.0484 16.875 15.75V4.5H1.125Z" fill="#333333"></path></svg>
                        <span class="f-12px">Return</span>
                    </p>
                    <span class="f-14px return-date font-500">22<sup>th</sup> Nov 2023</span>
                </div>
            </div>
            <div class="search-result-column d-none justify-content-between align-items-center p-0">
                <div class="search-class-detail">
                    ...
                    <span class="f-12px">Class</span>
                    </p>
                    <span class="f-14px class-category font-500">Economy</span>
                </div>
                <div class="search-result-passenger-detail">
                    <p class="m-0">
                        <svg xmlns="http://www.w3.org/2000/svg" width="12" height="13" viewBox="0 0 12 13" fill="none"><path d="M11.5292 10.609C11.2282 9.8793 10.7914 9.21645 10.2431 8.65741C9.69641 8.09676 9.04886 7.64976 8.33615 7.34108C8.32977 7.33781 8.32339 7.33618 8.31701 7.33291C9.31115 6.59799 9.95742 5.40088 9.95742 4.05025C9.95742 1.81281 8.18616 0 6 0C3.81384 0 2.04258 1.81281 2.04258 4.05025C2.04258 5.40088 2.68885 6.59799 3.68299 7.33455C3.67661 7.33781 3.67023 7.33945 3.66385 7.34271C2.94896 7.65138 2.30747 8.09397 1.75694 8.65905C1.20914 9.21851 0.772382 9.88126 0.470781 10.6107C0.174489 11.3248 0.0146918 12.0904 3.99029e-05 12.8661C-0.000386007 12.8835 0.00260125 12.9009 0.00882574 12.9171C0.0150502 12.9333 0.024386 12.9481 0.0362829 12.9606C0.0481797 12.9731 0.0623971 12.983 0.0780971 12.9898C0.0937971 12.9965 0.110662 13 0.127699 13H1.08514C1.15535 13 1.2112 12.9428 1.2128 12.8726C1.24471 11.6118 1.73939 10.431 2.61385 9.53606C3.51863 8.61005 4.72022 8.1005 6 8.1005C7.27978 8.1005 8.48137 8.61005 9.38615 9.53606C10.2606 10.431 10.7553 11.6118 10.7872 12.8726C10.7888 12.9445 10.8446 13 10.9149 13H11.8723C11.8893 13 11.9062 12.9965 11.9219 12.9898C11.9376 12.983 11.9518 12.9731 11.9637 12.9606C11.9756 12.9481 11.9849 12.9333 11.9912 12.9171C11.9974 12.9009 12.0004 12.8835 12 12.8661C11.984 12.0854 11.826 11.326 11.5292 10.609V10.609ZM6 6.8593C5.26756 6.8593 4.5782 6.56696 4.05959 6.03618C3.54097 5.5054 3.25534 4.79987 3.25534 4.05025C3.25534 3.30063 3.54097 2.5951 4.05959 2.06432C4.5782 1.53354 5.26756 1.24121 6 1.24121C6.73244 1.24121 7.4218 1.53354 7.94041 2.06432C8.45903 2.5951 8.74466 3.30063 8.74466 4.05025C8.74466 4.79987 8.45903 5.5054 7.94041 6.03618C7.4218 6.56696 6.73244 6.8593 6 6.8593Z" fill="#333333"></path></svg>
                        <span class="f-12px">Passenger(s)</span>
                    </p>
                    <span class="f-14px passengers-detail font-500">
                        <span>1 Adult</span>, <span>0 Child</span>, <span>0 Infant</span> 
                    </span>
                </div>
            </div>
