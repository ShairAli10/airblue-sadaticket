                                                        ...
                                                        <tr>
                                                            <td>
                                                                <p
                                                                    ...
                                                                    You've successfully register to {{ config('constants.SITE_TITLE') }} as customer.
                                                                    Please click the below button to verify your email. if button not working then copy then link
                                                                </p>
                                                        ...
                                                        <tr align="center">
                                                            <td>
                                                                <a href="{{ $verification_url }}"
                                                                    ...
                                                                    <button
                                                                        style=" background-color: #326ec6; border: none; color: #ffffff; border-radius: 8px; font-size: 18px; padding: 14px; font-weight: 600; cursor: pointer; ">
                                                                        Login Now
                                                                    </button>
                                                                </a>
                                                            </td>
