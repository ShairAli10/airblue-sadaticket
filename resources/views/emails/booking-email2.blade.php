...
<body style="font-family: Work Sans, sans-serif; background-color: #f1f3f;">
    <div>
        <div style="width: 100%; background-color: #f8f9fa;">
            ...
            <div style="background-color: #6ba605; color: #fff; padding: 15px; border-radius: 5px; box-shadow: 0 2px 3px #7e7e7e; background-image: linear-gradient(180deg, rgba(255, 255, 255, 0.25), rgba(255, 255, 255, 0));">
